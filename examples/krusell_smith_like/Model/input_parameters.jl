...
@label @long_name @latex_label @prior @flattenable @with_kw struct ModelParameters{T}
    ...
    β::T = 0.975 | "beta" | "discount factor" | L"\beta" | _ | false
    λ::T =
    ...
    ζ::T = 1 / 45000 | "zeta" | "probability to become entrepreneur" | L"\zeta" | _ | false

    # Technological parameters
    α::T = 0.318 | "alpha" | "capital share" | L"\alpha" | _ | false
    δ_0::T = (0.07 + 0.016) / 4 | "delta" | "depreciation rate" | L"\delta" | _ | false
    μ::T = 1.01 | "mu" | "price markup" | L"\mu" | _ | false
    μw::T = 1.01 | "mu_w" | "wage markup" | L"\mu_w" | _ | false
    ...
    ρ_Z::T = 0.998 | "rho_Z" | "autocorrelation of TFP shock" | L"\rho_Z" | _ | false
    σ_Z::T = 0.006 | "sigma_Z" | "standard deviation of TFP shock" | L"\sigma_Z" | _ | false
end
