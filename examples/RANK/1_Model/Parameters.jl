...
@label @latex_label @prior @flattenable @with_kw struct ModelParameters{T}
	...
	β::T = 0.99575 		| "beta" 		| L"\beta" 		|  Beta(beta_pars(0.99625, 0.001^2)...)  	| false # discount factor
	...
	τ_lev::T  = 0.74 	| "tau_lev" 	| L"\tau^L" 	|  _  										| false # steady-state income tax rate level
	τ_prog::T  = 0.1 	| "tau_pro" 	| L"\tau^P" 	|  _  										| false # steady-state income tax rate progressivity
	# Transfers?
	...
	RB::T = 1.0 | "RB" 	| L"RB"  		|  _  														| false # Nominal Interest Rate
    ...
    BhhBAR::T = 2.81  | "BhhBAR" |  L"BhhBAR"  |  _  | false
	...
	θ_π::T = 1.25 		| "theta_pi" 	| L"\theta_\pi" | Normal(1.0, 0.3)                			| true  # Reaction to inflation
	...
	γ_Bτ::T = 0.1 		| "gamma_Btau" 	| L"\gamma_B^\tau"| Normal(0.0, 1.0) 						| true  # reaction of tax level to debt
	...
	σ_Auth::T = 0.0 | "sigma_Auth" | L"\sigma_{Auth}" | InverseGamma(ig_pars(0.001, 0.02^2)...) | false # Std of government investment shock
...
@with_kw struct EstimationSettings
	...
	observed_vars_input::Array{Symbol, 1} 	= [:Ygrowth, :Igrowth, :GIgrowth, :Cgrowth, :N, :wgrowth, :RB,  :π, :TOP10Wshare, :TOP10Ishare]
	...
	data_file::String 						= "../../data/data_final/bbl_data_inequality_fullsample.csv"
