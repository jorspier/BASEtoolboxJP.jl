...
@label @long_name @latex_label @prior @flattenable @with_kw struct ModelParameters{T}
    ...
    α_S::T =
        0.50001 |
        "alpha_S" |
        "share of country 1 in world economy" |
        L"\alpha_S" |
        _ |
        false
    ω::T = 0.655 | "omega" | "Home Bias Measure" | L"\omega" | _ | false
    ϵ_e::T = 0.66 | "epsilon_e" | "Terms of Trade elasticity" | L"epsilon_e" | _ | false

    # Further steady-state parameters
    ψ::T = 0.1 | "psi" | "bond to capital ratio" | L"\psi" | _ | false
    ...
    # fiscal policy
    scale_prog::Bool =
        true | "scale_prog" | "scaling of tax rate with tax base" | "scale_prog" | _ | false
    spend_adj::T =
        0.0 |
        "gamma_B" |
    ...
    γ_B2::T =
        0.2 |
        "gamma_B" |
        "reaction of deficit to debt country 2" |
        L"\gamma_B" |
        Gamma(gamma_pars(0.1, 0.075^2)...) |
        false  # reaction of deficit to debt
    γ_π2::T =
        0.0 |
        "gamma_pi" |
        "reaction of deficit to inflation country 2" |
        L"\gamma_{\pi}" |
        Normal(0.0, 1.0) |
        false  # reaction of deficit to inflation
    γ_Y2::T =
        -0.3 |
        "gamma_Y" |
        "reaction of deficit to output country 2" |
        L"\gamma_Y" |
        Normal(0.0, 1.0) |
        false  # reaction of deficit to output
    ...
    ρ_A2::T =
        0.9 |
        "rho_A" |
        "autocorrelation of bond-spread shock country 2" |
        L"\rho_A" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        true
    σ_A2::T =
        0.0 |
        "sigma_A" |
        "standard deviation of bond-spread shock country 2" |
        L"\sigma_A" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_Z2::T =
        0.9 |
        "rho_Z" |
        "autocorrelation of TFP shock country 2" |
        L"\rho_Z" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        true
    σ_Z2::T =
        0.0 |
        "sigma_Z" |
        "standard deviation of TFP shock country 2" |
        L"\sigma_Z" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_ZI2::T =
        0.9 |
        "rho_Psi" |
        "autocorrelation of investment efficiency shock country 2" |
        L"\rho_\Psi" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        true
    σ_ZI2::T =
        0.0 |
        "sigma_Psi" |
        "standard deviation of investment efficiency shock country 2" |
        L"\sigma_\Psi" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_μ2::T =
        0.9 |
        "rho_mu" |
        "autocorrelation of price markup shock country 2" |
        L"\rho_\mu" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        true
    σ_μ2::T =
        0.0 |
        "sigma_mu" |
        "standard deviation of price markup shock country 2" |
        L"\sigma_\mu" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_μw2::T =
        0.9 |
        "rho_muw" |
        "autocorrelation of wage markup shock country 2" |
        L"\rho_{\mu w}" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        true
    σ_μw2::T =
        0.0 |
        "sigma_muw" |
        "standard deviation of wage markup shock country 2" |
        L"\sigma_{\mu w}" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_Rshock2::T =
        1e-8 |
        "rho_Rshock" |
        "autocorrelation of Taylor rule shock country 2" |
        L"\rho_{Rshock}" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        false
    σ_Rshock2::T =
        0.0 |
        "sigma_Rshock" |
        "standard deviation of Taylor rule shock country 2" |
        L"\sigma_R" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_Gshock2::T =
        0.98 |
        "rho_Gshock" |
        "autocorrelation of deficit shock country 2" |
        L"\rho_D" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        true
    σ_Gshock2::T =
        0.00 |
        "sigma_G" |
        "standard deviation of deficit shock country 2" |
        L"\sigma_D" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_Tprogshock2::T =
        1e-8 |
        "rho_Pshock" |
        "autocorrelation of tax progressivity shock country 2" |
        L"\rho_{Pshock}" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        false
    σ_Tprogshock2::T =
        0.0 |
        "sigma_Pshock" |
        "standard deviation of tax progressivity shock country 2" |
        L"\sigma_P" |
        InverseGamma(ig_pars(0.001, 0.02^2)...) |
        true
    ...
    ρ_β2level::T =
        0.9999 |
        "rho_beta2l" |
        "Persistence of idiosyncratic income risk" |
        L"\beta_2l" |
        Beta(beta_pars(0.5, 0.2^2)...) |
        true
    ρ_β2shock::T =
